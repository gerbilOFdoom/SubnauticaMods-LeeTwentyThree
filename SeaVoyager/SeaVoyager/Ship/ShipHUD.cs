...
namespace ShipMod.Ship
{
    public class ShipHUD : MonoBehaviour
    {
        ...
        void SetupHUD()
        {
            ...
            directionSpriteInactive = Plugin.bundle.LoadAsset<Sprite>("ArrowOff");
            directionSpriteActive = Plugin.bundle.LoadAsset<Sprite>("ArrowOn");

            switchedOn = Plugin.bundle.LoadAsset<Sprite>("ShipOn");
            switchedOff = Plugin.bundle.LoadAsset<Sprite>("ShipOff");

            spriteCamActive = Plugin.bundle.LoadAsset<Sprite>("CameraOn");
            spriteCamInactive = Plugin.bundle.LoadAsset<Sprite>("CameraOff");

            spriteSonarActive = Plugin.bundle.LoadAsset<Sprite>("SonarOn");
            spriteSonarInactive = Plugin.bundle.LoadAsset<Sprite>("SonarOff");

            spriteMapActive = Plugin.bundle.LoadAsset<Sprite>("MapOn");
            spriteMapInactive = Plugin.bundle.LoadAsset<Sprite>("MapOff");

            speed1Active = Plugin.bundle.LoadAsset<Sprite>("SpeedSetting1");
            speed1Inactive = Plugin.bundle.LoadAsset<Sprite>("SpeedSetting1Inactive");
            speed2Active = Plugin.bundle.LoadAsset<Sprite>("SpeedSetting2");
            speed2Inactive = Plugin.bundle.LoadAsset<Sprite>("SpeedSetting2Inactive");
            speed3Active = Plugin.bundle.LoadAsset<Sprite>("SpeedSetting3");
            speed3Inactive = Plugin.bundle.LoadAsset<Sprite>("SpeedSetting3Inactive");
            ...
            buttonPressSound = Plugin.bundle.LoadAsset<AudioClip>("ButtonPress");
        }
